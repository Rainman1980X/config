...
public class RegistrationService {
    ...
    @Value("${s3f.serviceClass}")
    private String serviceClass;
    @Value("${s3f.serviceName}")
    ...
    public void register() throws Exception {
        ...
        RegisterInfo registerInfo = registerInfoFactory.build(serviceName, serviceClass, serverPort, lifeCycle.getKey());
        final S3FEvent s3FEvent = new S3FEvent("", "", domain, "register.service", serviceName, registerInfo);
    ...
    public void deregister() throws Exception {
        ...
        RegisterInfo registerInfo = registerInfoFactory.build(serviceName, serviceClass, serverPort, lifeCycle.getKey());
        final S3FEvent s3FEvent = new S3FEvent("", "", domain, "deregister.service", serviceName, registerInfo);
        LOGGER.info(s3FEvent.toJson());
        systemQueuePublisher.basicPublish(amqpKey, s3FEvent);
    }
}
