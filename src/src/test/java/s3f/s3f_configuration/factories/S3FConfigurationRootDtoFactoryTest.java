...
public class S3FConfigurationRootDtoFactoryTest {
	...
	S3FConfiguration s3FConfiguration = new S3FConfiguration("1", keyValuePairsOfS3FConfiguration, version,
	...
	S3FConfigurationRootDto s3FConfigurationRootDto = new S3FConfigurationRootFactory()
	...
	return new S3FConfigurationRootDto(id, keyValuePairs, version, lifecycle, serviceName);
    }
}